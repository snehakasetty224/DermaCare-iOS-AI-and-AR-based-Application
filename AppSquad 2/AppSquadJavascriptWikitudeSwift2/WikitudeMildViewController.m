...
#import "WikitudeMildViewController.h"
...
@interface WikitudeMildViewController () <WTArchitectViewDelegate, WTArchitectViewDebugDelegate>

/* Add a strong property to the main Wikitude SDK component, the WTArchitectView */
@property (nonatomic, strong) WTArchitectView               *architectView;  // It uses this class
...
@implementation WikitudeMildViewController

@synthesize st1=st1; // severe or no variable
...
- (void)viewDidLoad {
    ...
    if ( [WTArchitectView isDeviceSupportedForRequiredFeatures:WTFeature_2DTracking error:&deviceSupportError] ) {
        ...
        {
            //LoadArchitectWorlFromURL provided by WTArchitectView to load ArchitectWorl

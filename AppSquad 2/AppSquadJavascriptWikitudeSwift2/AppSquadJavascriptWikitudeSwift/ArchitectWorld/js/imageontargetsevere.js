...
createOverlays: function createOverlaysFn() {
    ...
    var newRash = new AR.Label("Rash is Severe, Contact Doctor", .2, {
                               zOrder: 1,
                               translate: {
                               y: -0.15
                               },
    ...
    var htmlWidgetsevere = new AR.HtmlDrawable({
                                               uri: "assets/severe.html"
                                               }, 1.0, {
                                               viewportWidth: 320,
                                               viewportHeight: 300,
    ...
    var soundsevere = new AR.Sound("assets/severe.mp3", {
                                 onLoaded : function(){soundsevere.play();},
                                 onError : function(){
                                 // alert the user that the sound file could not be loaded
                                 },
                                 });

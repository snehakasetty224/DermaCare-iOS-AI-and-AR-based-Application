...
class BookAppointmentController: UIViewController,UITextFieldDelegate
{
    ...
    @IBAction func bookAppt(_ sender: Any) {
        ...
        //VALUES COMING FROM TEXT FIELD TO PERFORM BOOK APPOINTMENT
        ...
        if selectedDoctor != nil {
            ...
            if HKHealthStore.isHealthDataAvailable() {
                ...
                if(profile.bloodType != nil){
                    typeStr = bloodTypeLiteral(profile.bloodType!.bloodType)
                    print(typeStr)
                }
                ...
                if(profile.biologicalsex != nil){
                    sexStr = biologicalSexLiteral(profile.biologicalsex!.biologicalSex)
                    print(sexStr)
                }

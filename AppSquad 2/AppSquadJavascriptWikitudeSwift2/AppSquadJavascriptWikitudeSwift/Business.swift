...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String,  locationVal : String, completion: @escaping ([Business]?, Error?) -> Void) {
        _ = YelpClient.sharedInstance.searchWithTerm(term,  locationVal: locationVal, completion: completion)
    }
    
    class func searchWithTerm(term: String, locationVal : String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, completion: @escaping ([Business]?, Error?) -> Void) -> Void {
